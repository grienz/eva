...
export function Container(props: ContainerProps) {
  ...
  return (
    <div className="flex flex-col justify-center bg-slate-100 text-slate-500 dark:bg-slate-900 dark:text-slate-400 ">
      ...
      <main
        id="skip"
        className="mx-auto flex min-w-fit max-w-3xl flex-col justify-center bg-slate-100  px-6 text-lg text-slate-500 dark:bg-slate-900 dark:text-slate-400 md:px-8"
      >
        <Header />
        {props.children}
        <ScrollTopButton />
