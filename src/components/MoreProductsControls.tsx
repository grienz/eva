    ...
    <div className="flex w-full flex-row flex-nowrap  place-items-center justify-center">
      {isDisabled ? (
        ...
        <Link href={`/product/list/1`}>
          <a className="navbar-link group inline-flex items-center  text-base font-medium text-gray-800  transition-all delay-100 hover:text-sky-600 dark:text-gray-200 dark:hover:text-sky-400">
            <span>{`${t("more_products")} →`}</span>
          </a>
        </Link>
      )}
