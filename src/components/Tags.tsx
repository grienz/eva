      ...
      {tags &&
        tags.map((tag) => (
          <Link href={`/tag/${tag.tagSlug}`} key={tag.tagSlug}>
            <a className="ml-3 mt-2 mb-2 flex rounded-lg border border-slate-400 px-1 text-sm lowercase text-gray-600  transition-all  delay-100 hover:border-teal-800 hover:text-teal-800 dark:hover:border-teal-400 dark:hover:text-teal-400">
